...
"""
    ...
    You can put complex config in `test_permissions_helpers.py`, and then import it where needed:
        ...
        viewable_section = [
         ...
         # views.py
        from .test.test_permissions_helpers import viewable_section

        @perms_test(viewable_section))
        def some_view(request, resource, format=None): ...
"""
